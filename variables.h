...
#define maglockControlPin 33
#define magLockReadbackPin 32
#define inductiveSensorPin 10
#define manualOpenPin 25
#define doorOpenAlarm 24
#define doorOpenButtonlLED 27
#define statusPin 26

#define maglockReadbackDefault HIGH
#define inductiveSensorDefault HIGH

#define maglockDefaultOn LOW// maglock is activated

#define doorOpenCountdown 7000 // 7 seconds until warning

//Should ESP run in AP or client mode?
#define AP 0
#define CLIENT 1

char * pwd = "a6Jd2FJboXseHxPwTs94s8LTPWvFIPxf"; //32 characters long
...
uint8_t byteOrder[16] = {0, 5, 12, 6, 13, 7, 10, 15, 4, 3, 9, 2, 14, 8, 11, 15};
//Array valueOrter needs to begin with 255.
...
uint16_t cardReadInterval = 1000;
...
#elif CLIENT
const char* ssid = "TAKT";
const char* password = "taktspejs";
#endif
